...
- v0.1.1 (2026-09-18) ships the finished CI slice early: `sarif`, `github`, `markdown` and `junit` formats, `-o`, GitHub Actions auto-detection, the GitHub Action, `install.sh --uninstall`, and the v0.1.0 bug fixes. v0.2.0 stays reserved for the framework adapters.
